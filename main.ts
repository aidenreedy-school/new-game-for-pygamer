...
let taps_req = 0
let tap = 0
let newcatch_pics: Image[] = []
let fish_names: string[] = []
let fishes: Image[] = []
let water_jiggle_ani: Image[] = []
let fishingrod: Image[] = []
let newest_catch: Sprite = null
let fisher: Sprite = null
...
fisher = sprites.create(img`
    ...
    . . . . . . . . . . . . 
    `, SpriteKind.Player)
newest_catch = sprites.create(img`
    ....................
    ....................
    ....................
    ....................
...
game.onUpdateInterval(5000, function () {
    ...
    temp_rand_loc = randint(50, 156)
    if (temprand1 == 3 && !(reeling2)) {
...
forever(function () {
    ...
    newest_catch.setPosition(boat.x - 14, boat.y - 3)
})
