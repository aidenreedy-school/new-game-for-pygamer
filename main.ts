...
function cast_ani () {
    rod.setImage(fishingrod[0])
    pause(200)
    rod.setImage(fishingrod[3])
    pause(200)
    rod.setImage(fishingrod[2])
    pause(200)
    rod.setImage(fishingrod[1])
}
let temp_rand_loc = 0
let temprand1 = 0
...
rod = sprites.create(img`
    ...
    ...................................
    `, SpriteKind.Player)
let water_jiggle = sprites.create(img`
...
game.onUpdateInterval(1000, function () {
    ...
    if (temprand1 == 3) {
        ...
        water_jiggle.setImage(water_jiggle_ani[0])
        pause(100)
        water_jiggle.setImage(water_jiggle_ani[1])
        pause(100)
        water_jiggle.setImage(water_jiggle_ani[2])
        pause(100)
        water_jiggle.setImage(water_jiggle_ani[3])
        pause(100)
        water_jiggle.setImage(water_jiggle_ani[4])
    }
})
forever(function () {
    fisher.setPosition(boat.x, boat.y - 3)
    rod.setPosition(boat.y - 7, boat.y - 7)
})
